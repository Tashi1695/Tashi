class Solution(object):
    def climbStairs(self, n):
        memo = {} # Initialize an empty dictionary to store computedresults
        return self.ways(n, memo) # Call the ways method with n andmemo as arguments and return the result
    def ways(self, n, memo):
# Define a helper method named ways which takes n and memo as input
        if n in memo: # Check if the result for n is already computedand stored in memo 
